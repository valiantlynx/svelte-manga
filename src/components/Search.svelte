...
<main class="p-2">
  <form>
    <div class="relative">
      ...
      <input type="text" id="searchTerm" name="searchTerm" placeholder="Search..." class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
  ...
  {#if loading}
    <div class="mt-4 flex items-center space-x-2">
      <div class="animate-spin rounded-full h-5 w-5 border-t-2 border-b-2 border-gray-900"></div>
      <span>Loading...</span>
    </div>
  {/if}
